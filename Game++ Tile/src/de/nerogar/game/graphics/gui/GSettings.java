...
public class GSettings extends Gui {
	...
	public GSettings() {
		...
		sliderMusic = new GESlider(new Vector(posX, 200), new Vector(Map.TILE_RENDER_SIZE * 4, Map.TILE_RENDER_SIZE), "a", 0, 1);
		sliderEffects = new GESlider(new Vector(posX, 300), new Vector(Map.TILE_RENDER_SIZE * 4, Map.TILE_RENDER_SIZE), "a", 0, 1);
